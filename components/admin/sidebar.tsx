    ...
    <>
            <div className="group w-[54px] fixed flex flex-col top-0 left-0 hover:w-64 bg-white h-full border-r transition-all duration-700 ease-in-out">
                ...
                <ul className="flex flex-col py-4 space-y-1">
                    ...
                    <li className="px-5">
                    <div className="flex flex-row items-center h-8">
                        <div className="hidden group-hover:inline-block text-sm font-light tracking-wide text-gray-500">Tasks</div>
                    </div>
                    </li>
                    <li>
                    <a href="#" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                    ...
                    <li className="px-5">
                    <div className="flex flex-row items-center h-8">
                        <div className="hidden group-hover:inline-block text-sm font-light tracking-wide text-gray-500">Settings</div>
                    </div>
                    </li>
                    <li>
                    <a href="#" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
